...
#define atomic_compare_exchange_u16(a, expected_ptr, desired) __atomic_compare_exchange_n((u16*) (a), expected_ptr, desired, 0 /* is_weak */, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST), *(expected_ptr)
#define atomic_compare_exchange_u32(a, expected_ptr, desired) __atomic_compare_exchange_n((u32*) (a), expected_ptr, desired, 0 /* is_weak */, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST), *(expected_ptr)
#define atomic_compare_exchange_u64(a, expected_ptr, desired) __atomic_compare_exchange_n((u64*) (a), expected_ptr, desired, 0 /* is_weak */, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST), *(expected_ptr)
