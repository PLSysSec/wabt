...
DEFINE_ATOMIC_RMW_XCHG(i32_atomic_rmw16_xchg_u, u16, u32)
DEFINE_ATOMIC_RMW_XCHG(i32_atomic_rmw_xchg, u32, u32)
DEFINE_ATOMIC_RMW_XCHG(i64_atomic_rmw8_xchg_u, u8, u64)
DEFINE_ATOMIC_RMW_XCHG(i64_atomic_rmw16_xchg_u, u16, u64)
