const char* s_source_atomicops_declarations = R"w2c_template(#if defined(_MSC_VER)
)w2c_template"
R"w2c_template(
#include <intrin.h>
)w2c_template"
...
R"w2c_template(
#define atomic_compare_exchange_u8(a, expected_ptr, desired) __atomic_compare_exchange_n((u8*) (a), expected_ptr, desired, 0 /* is_weak */, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST), *(expected_ptr)
)w2c_template"
R"w2c_template(#define atomic_compare_exchange_u16(a, expected_ptr, desired) __atomic_compare_exchange_n((u16*) (a), expected_ptr, desired, 0 /* is_weak */, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST), *(expected_ptr)
)w2c_template"
R"w2c_template(#define atomic_compare_exchange_u32(a, expected_ptr, desired) __atomic_compare_exchange_n((u32*) (a), expected_ptr, desired, 0 /* is_weak */, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST), *(expected_ptr)
)w2c_template"
R"w2c_template(#define atomic_compare_exchange_u64(a, expected_ptr, desired) __atomic_compare_exchange_n((u64*) (a), expected_ptr, desired, 0 /* is_weak */, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST), *(expected_ptr)
)w2c_template"
R"w2c_template(
